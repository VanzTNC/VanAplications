...
<html>
<head>
  <title>VanLaundry ! Resgitrasi</title>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          ...
          <h4><span class="glyphicon glyphicon-user"></span> Resgitrasi</h4>
        </div>
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form  role="form" method="post" action=""> 
            <div class="form-group">
             ...
             <div class="form-group">
             <label for="psw"><span class="glyphicon glyphicon-phone"></span> No Telp </label>
        ...
        <div class="modal-footer">
          ...
          <p>Sudah Register <a href="Login.php ">Login</a></p>
        </div>
      </div>
