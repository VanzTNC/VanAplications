...
<div class="container">
	...
	<i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:Irvan.nugraha248@Gmail.com">Irvan.nugraha248@Gmail.com</a>
	</div>
	<div class="col-md-6 w3_c">
	<i class="fa fa-phone" aria-hidden="true"></i> +62 5972 8365 37
	</div>
...
<nav class="navbar navbar-default ">
  <div class="container">
    ...
    <div class="navbar-header">
     ...
     <h1><a class="navbar-brand" href="#">VanLaundry</a></h1>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li><a href="#services" class="page-scroll">SERVIS</a></li>
...
<div class="w3l_bandwn">
 <h2>Selamat datang di VanLaundry</h2>
...
<a href="#" data-toggle="modal" data-target="#myModal">Selengkapnya </a>
  <div class="modal video-modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModal">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">VanLaundry</h4>
        </div>
        <div class="modal-body">
		<img src="images/modal.jpg"  class="img-responsive" alt="tfg">
          <p>Layanan kami tidak hanya cepat, bersih, efisien, tetapi juga sangat dapat diandalkan. Eksekutif layanan pelanggan kami dilatih secara khusus untuk memberikan panduan dan memastikan pengiriman tepat waktu.</p>
        </div>
                          ...
                          <table class="table" style="color: black">
                            <thead>
                              <tr align="text-center">
                                ...
                                <th ><center>Cuci Bersih</center></th>
		...
		<div class="container">
			<div class="list">
				...
				<div class="col-md-6 wthree_fc">
					<h6> Jalan PangeranBungsu </h6>
					<h6> Cisarua</h6>
					<h6> Sumedang </h6>
					</div>
					
					<div class="col-md-3 wthree_fr">
					<h6>+62 5972 8365 37</h6>
					<h6><a href="mailto:service@decorate.com">irvan.nugraha248@Gmail.com</a></h6>
					</div>
			</div>
		</div>
	</div>
...
<div class="copyright">
		<div class="container">
			<p>© <?php echo date('Y');?> VanLaundry. All rights reserved | Design by <a href="">Irvan Nugraha</a></p>
		</div>
</div>
